...
bool interfaces__msg__tutorial__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._tutorial.Tutorial", full_classname_dest, 33) == 0);
  }
  interfaces__msg__Tutorial * ros_message = _ros_message;
  {  // first_name
...
{
  /* NOTE(esteve): Call constructor of Tutorial */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._tutorial");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Tutorial");
