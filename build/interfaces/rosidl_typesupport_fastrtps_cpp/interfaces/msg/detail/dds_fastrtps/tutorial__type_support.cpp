...
#include "interfaces/msg/detail/tutorial__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::Tutorial & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::Tutorial & ros_message)
{
  // Member: first_name
  cdr >> ros_message.first_name;
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Tutorial *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Tutorial *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Tutorial__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, Tutorial)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_Tutorial__handle;
}
